...
pub const PIECE_VALUE_MG: [Eval; 12] = [
     82,  337,  365,  477, 1025, 0,
    -82, -337, -365, -477,-1025, 0,
];

pub const PIECE_VALUE_EG: [Eval; 12] = [
...
pub static PST_MG: Lazy<[[Eval; 64]; 12]> = Lazy::new(|| {
...
/// Endgame PST[piece][square]
pub static PST_EG: Lazy<[[Eval; 64]; 12]> = Lazy::new(|| {
